...
const vacationSchema = new Schema<Vacation>(
  {
    ...
    savedAccessRoleIds: { type: [String], default: [] },
    savedAcceptedRoleIds: { type: [String], default: [] },
    savedAssignedRoleIds: { type: [String], default: [] },
    savedTypeRoleIds: { type: [String], default: [] },
    snapshotRoleLevel: { type: Number },
